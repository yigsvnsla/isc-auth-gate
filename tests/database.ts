...
export async function cleanupTestDb() {
  ...
  await testPool.query(`
    TRUNCATE TABLE sessions, accounts, verifications, members, invitations, organizations, users, organization_roles, oauth_clients, oauth_access_tokens, oauth_refresh_tokens, oauth_consents, oauth_client_resources, oauth_resources, oauth_client_assertions, device_codes, apikeys RESTART IDENTITY CASCADE;
  `);
}

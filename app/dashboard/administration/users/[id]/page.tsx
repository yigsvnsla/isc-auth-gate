...
export default function UserIdPage() {
  ...
  const { data: sessionsInfo } = useSWR(
    ...
    async (args) => {
      const [, userId] = args;
      return authClient.admin.listUserSessions({ userId }, { throw: true });
    },
    {
      fallbackData: { sessions: [] } as ReturnType<
        ...
        <div className="flex gap-4 lg:flex-1">
          ...
          <div className="flex flex-col gap-1">
            <h1 className="text-xl lg:text-2xl font-semibold tracking-tight">
              {userLoading ? <Skeleton className="h-8 w-48" /> : userInfo?.name}
            </h1>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      sessions and accounts will be permanently deleted.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
            ...
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="grid gap-1 flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {userInfo?.createdAt
                      ? format(userInfo.createdAt, "MMM d, yyyy")
                      : "—"}
                  </p>
                </div>
              </div>
            ...
            <CardContent className="grid gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs font-mono text-muted-foreground">
                    {userInfo?.createdAt
                      ? format(userInfo.createdAt, "MMM d, yyyy HH:mm:ss")
                      : "—"}
                  </p>
                  {userInfo?.createdAt && (
                    <p className="text-xs text-muted-foreground mt-0.5">
                      {formatDistanceToNowStrict(userInfo.createdAt, {
                        addSuffix: true,
                      })}
                    </p>
                  )}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs font-mono text-muted-foreground">
                    {userInfo?.updatedAt
                      ? format(userInfo.updatedAt, "MMM d, yyyy HH:mm:ss")
                      : "—"}
                  </p>
                </div>
              </div>
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      This user will be signed out from this
                                      device.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  OAuth and linked authentication methods
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <TableRow key={i}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                          ...
                          {formatDistanceToNowStrict(log.timestamp, {
                            addSuffix: true,
                          })}
                        </div>
                      </TableCell>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Delete this user?</AlertDialogTitle>
                <AlertDialogDescription>
                  This action cannot be undone. All user data including sessions
                  and accounts will be permanently deleted.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                <AlertDialogCancel>Cancel</AlertDialogCancel>
